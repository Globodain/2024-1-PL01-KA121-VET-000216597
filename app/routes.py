...
from app.forms import LoginForm, RegistrationForm, EditProfileForm, ResetPasswordRequestForm, EmptyForm, PostForm, ResetPasswordForm
...
def index():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(post)
        db.session.commit()
        flash(f'You have published a post')
    ...
    return render_template('index.html', title='Home', form=form, post=posts.items, next_url=next_url, prev_url=prev_url)
